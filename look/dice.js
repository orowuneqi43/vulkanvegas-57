...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-f5b7f96d');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-f5b7f96d');}
...
function clearFlash(){dieView.classList.remove('rl-win-f5b7f96d');dieView.classList.remove('rl-lose-f5b7f96d');if(frameEl){frameEl.classList.remove('rl-win-f5b7f96d');frameEl.classList.remove('rl-lose-f5b7f96d');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-f5b7f96d');if(frameEl){frameEl.classList.add('rl-win-f5b7f96d');}}else{dieView.classList.add('rl-lose-f5b7f96d');if(frameEl){frameEl.classList.add('rl-lose-f5b7f96d');}}
...
var brandEl=document.querySelector('.rl-brand-f5b7f96d');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
